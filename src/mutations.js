...
export const UPDATE_ASSET_PRICE_REQUEST = 'UPDATE_ASSET_PRICE_REQUEST';
export const UPDATE_ASSET_PRICE_COMPLETE = 'UPDATE_ASSET_PRICE_COMPLETE';
export const UPDATE_ASSET_PRICE_ERROR = 'UPDATE_ASSET_PRICE_ERROR';
