...
export const FETCH_ASSET_PRICE_REQUEST = 'FETCH_ASSET_PRICE_REQUEST';
export const FETCH_ASSET_PRICE_COMPLETE = 'FETCH_ASSET_PRICE_COMPLETE';
export const FETCH_ASSET_PRICE_ERROR = 'FETCH_ASSET_PRICE_ERROR';
